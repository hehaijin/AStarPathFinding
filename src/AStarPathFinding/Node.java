...
public class Node 
{
	...
	ArrayList<Node> edges=new ArrayList<>();  // this arraylist holds all the nodes that is adjacent to this node.
  ...
  */
	 ...
	 * Takes a string input, and Assign it to member variable str.
	 * @param str
	 */
